...
useEffect(() => {
  if (!userId) return;
  axios
    .get(`https://3.137.162.97:5001/api/cart?userId=${userId}`)
  ...
  const updateQuantity = (id, change) => {
    ...
    axios.put("https://3.137.162.97:5001/api/cart/update", {
      id,
  ...
  const removeItem = (id) => {
    axios.delete(`https://3.137.162.97:5001/api/cart/${id}`).then(() => {
